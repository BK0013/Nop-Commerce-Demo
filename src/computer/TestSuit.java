...
public class TestSuit extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_FirstName']")).sendKeys("BK");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_LastName']")).sendKeys("Patel");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_Email']")).sendKeys("bkpatel13+@.com");
        selectValueFromdropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "240");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_City']")).sendKeys("High Street");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_Address1']")).sendKeys("13, high street");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']")).sendKeys("AI10 8EF");
        ...
        driver.findElement(By.xpath("//input[@id='CardholderName']")).sendKeys("MR.BK");
        driver.findElement(By.xpath("//input[@id='CardNumber']")).sendKeys("7866558855669977");
        selectValueFromdropDown(By.xpath("//select[@id='ExpireMonth']"), "8");
        selectValueFromdropDown(By.xpath("//select[@id='ExpireYear']"), "2024");
        driver.findElement(By.xpath("//input[@id='CardCode']")).sendKeys("143");
